...
if ($con->query("update godownuser SET email='$_POST[email]',pass='$_POST[password]' where id='$_SESSION[userId]'")) {

  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
  header("location:GaccountSetting.php?notice=Successfully saved");
}
else{
  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
        <a href="goDowninventery.php"><li><i class="fa fa-circle-o fa-fw"></i> Inventeries</li></a>
       <a href="Gaddnew.php"><li ><i class="fa fa-circle-o fa-fw"></i> Add New Item</li></a>
      </ul><
    </div>
  </div>
...
<div class="account" style="display: none;">
  ...
  <div class="content2">
<ol class="breadcrumb ">
        <li><a href="goDownInventery.php"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="password" name="password" value=<?php echo $user['pass'] ?> class="form-control" id="some"  required>
          </div>
          <div class="center">
