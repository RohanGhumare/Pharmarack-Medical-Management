...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div class="flex" style="padding: 3px 7px;margin:5px 2px;">
    <div><img src="photo2/<?php echo $user['pic'] ?>" class='img-circle' style='width: 77px;height: 66px'></div>
  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="return.php"><li><i class="fa fa-circle-o fa-fw"></i> Return</li></a>
       <a href="returndb.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Return Product</li></a>
...
<div class="marginLeft" >
  <div style="color:white;background:#3C8DBC" >
    <div class="pull-right flex rightAccount" style="padding-right: 11px;padding: 7px;">
      <div><img src="photo2/<?php echo $user['pic'] ?>" style='width: 41px;height: 33px;' class='img-circle'></div>
...
if (isset($_GET['catId']))
{
  ...
  $stockArray = $con->query("select * from returnproduct where catId='$catArray[id]'");
 
}
else
{
  $catName = "Return Product";
  $stockArray = $con->query("select * from returnproduct");
}
        ...
        ?>
          <tr>
            ...
            <td id='selection<?php echo $i; ?>'><button class="btn btn-primary btn-xs" onclick="addInBill('<?php echo $id ?>','<?php echo $i; ?>')">Select</button></td>
              ...
              <td id='selection<?php echo $i; ?>'><button class="btn btn-primary btn-xs" onclick="addInBill('<?php echo $id ?>','<?php echo $i; ?>')">Select</button></td>
              <?php } ?>
              <td colspan="center"><a href="delete.php?product=<?php echo $row['id'] ?>&url=<?php echo $_SERVER['QUERY_STRING'] ?>"><button class='btn btn-danger btn-xs'>Delete Item</button></a></td>
          </tr>
      <?php
        }
       ?>
