  ...
  <div>
    ...
    <div class="item">
      <ul class="nostyle zero">
       ...
       <a href="return.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Return</li></a>
       <a href="returndb.php"><li><i class="fa fa-circle-o fa-fw"></i> Return Product</li></a>
...
if ($con->query("insert into returnproduct(name,price,company)  values ('$_POST[name]','$_POST[price]','$_POST[company]')")) {
  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
}
else{
