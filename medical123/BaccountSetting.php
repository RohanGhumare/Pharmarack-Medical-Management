...
<?php require 'assets/branchdb.php';?>
<!DOCTYPE html>
<html>
<head>
...
if ($con->query("update branchuser SET email='$_POST[email]',pass='$_POST[password]' where id='$_SESSION[userId]'")) {

  $notice ="<div class='alert alert-success'>Successfully Saved</div>";
  header("location:BaccountSetting.php?notice=Successfully saved");
}
else{
...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="BaccountSetting.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Account Setting</li></a>
