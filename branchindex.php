...
<div class="account" style="display: none;">
  ...
  <div class="content2">
    ...
    <div>
      ...
      <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addIn" style="margin-left: 2px;"><i class="fa fa-plus fa-fw"> </i>Add New Branch</button> 
      <a href="manageCat.php"><button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#addIn"><i class="fa fa-gear  fa-fw"> </i> Manage Branch</button></a>
  ...
  ?>
    <a href="branchDB.php?catId=<?php echo $row['id'] ?>"><div class="box2 col-md-3">
      <hr style="margin: 7px;">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="safeIn">Save Branch</button>
      </div>
    </form>
    </div>
