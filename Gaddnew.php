...
<a href="Gaddnew.php"><li><i class="fa fa-circle-o fa-fw"></i> Add New Item</li></a>
  ...
  <div class="item">
      <ul class="nostyle zero">
        ...
        <a href="GaccountSetting.php"><li><i class="fa fa-circle-o fa-fw"></i> Account Setting</li></a>
    ...
    <div style="width: 55%;margin: auto;padding: 22px;" class="well well-sm center">
      ...
      <form method="POST">
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="some" class="col-form-label">Select Branch</label>
            <select class="form-control" required name="catId">
              <option selected disabled value="">Please Select Branch</option>
            <?php getAllCat(); ?>
